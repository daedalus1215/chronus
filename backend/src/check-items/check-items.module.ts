...
import { GetCheckItemTransactionScript } from './domain/transaction-scripts/get-check-item-TS/get-check-item.transaction.script';
import { ToggleCheckItemTransactionScript } from './domain/transaction-scripts/toggle-check-item-TS/toggle-check-item.transaction.script';
import { DeleteCheckItemTransactionScript } from './domain/transaction-scripts/delete-check-item-TS/delete-check-item.transaction.script';
import { UpdateCheckItemTransactionScript } from './domain/transaction-scripts/update-check-item-TS/update-check-item.transaction.script';
import { UpdateCheckItemStatusTransactionScript } from './domain/transaction-scripts/update-check-item-status-TS/update-check-item-status.transaction.script';
import { GetCheckItemsByNoteTransactionScript } from './domain/transaction-scripts/get-check-items-by-note-TS/get-check-items-by-note.transaction.script';
import { ReorderCheckItemsTransactionScript } from './domain/transaction-scripts/reorder-check-items-TS/reorder-check-items.transaction.script';
...
@Module({
  ...
  providers: [
    ...
    DeleteCheckItemsByNoteListener,
    {
      ...
      useExisting: CheckItemsAggregator,
    },
  ],
  controllers: [
